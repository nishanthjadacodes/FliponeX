      ...
      >
        <View style={styles.header}>
          <View style={styles.bookingInfo}>
            <Text style={styles.bookingNumber}>#{booking.booking_number || booking.bookingNumber || booking.id}</Text>
        ...
        <View style={styles.details}>
          <View style={styles.detailRow}>
            ...
            <Text style={styles.detailValue}>{booking.customer_name || booking.customerName || booking.fullName || 'N/A'}</Text>
          </View>
          <View style={styles.detailRow}>
          ...
          <View style={styles.detailRow}>
            ...
            <Text style={styles.detailValue}>₹{booking.total_amount || booking.totalAmount || booking.price_quoted || 0}</Text>
          </View>
          {(booking.address || booking.service_address) && (
            <View style={styles.detailRow}>
              <Text style={styles.detailLabel}>Address:</Text>
              <Text style={styles.detailValue} numberOfLines={2}>{booking.address || booking.service_address}</Text>
            </View>
          )}
        </View>
      </Pressable>
...
const styles = StyleSheet.create({
  card: {
    ...
    marginHorizontal: SIZES.BASE, marginVertical: SIZES.BASE / 2, padding: SIZES.BASE,
