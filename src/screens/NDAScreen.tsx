...
const CLAUSES: Clause[] = [
  ...
  },
  {
    ...
    body:
      'Industrial / B2B records are accessible only to designated Senior Experts and B2B Admins. General field representatives do not have visibility into your corporate vault.',
  },
  {
...
const NDAScreen: React.FC<NDAScreenProps> = ({ navigation }) => {
