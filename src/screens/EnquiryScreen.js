...
const pickChecklist = (serviceName = '') => {
...
const EnquiryScreen = ({ navigation, route }) => {
  ...
  const submit = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Enquiry Submitted',
        "We've received your request. A B2B expert will review the scope and share a quote within 24 business hours.",
    ...
    >
      <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
        ...
        <Text style={styles.footNote}>
          A B2B expert reviews every enquiry, shares a quote and schedules a call. No charges apply until you accept the quote.
        </Text>
