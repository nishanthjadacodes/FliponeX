...
const SECTIONS: SectionDef[] = [
  ...
  },
  {
    ...
    hint: 'Day-to-day contact for our field representatives',
    fields: [
...
const CompanyProfileScreen: React.FC<CompanyProfileScreenProps> = ({ navigation, route }) => {
  ...
  const setField = (key: string, value: string, auto?: 'upper' | 'lower', max?: number): void => {
    let v = value;
