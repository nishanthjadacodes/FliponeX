...
• Visiting Fee: If the representative reaches the location and the service is cancelled by the user, a ₹99 visiting fee will apply.
...
export const FAQS: FAQ[] = [
  {
    ...
    a: 'Every FliponeX representative carries a verified ID. You can cross-check the representative name and photo shown in your live booking details before handing over any documents.',
  },
  {
